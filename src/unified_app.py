    ...
    def health() -> dict:
        return {
            ...
            "services": {
                ...
                "notifications_suppress": "/api/notifications/suppress",
                ...
                "faults_limits": "/api/faults/limits",
                "fleet_export": "/api/fleet/export",
                "fleet_report": "/api/reports/fleet.html",
                "maintenance_plan": "/api/maintenance/plan",
                "workorders": "/api/maintenance/workorder",
                "simulate": "/api/simulate/snapshot",
            },
            "digital_twin": {
