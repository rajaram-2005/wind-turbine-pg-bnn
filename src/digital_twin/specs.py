...
SPECS_LIBRARY: dict[str, TurbineSpec] = {
    ...
    "Suzlon-S97": TurbineSpec(
        model_name="S97 2.1 MW",
        manufacturer="Suzlon Energy",
        rated_power_mw=2.1,
        rotor_diameter_m=97.0,
        hub_height_m=90.0,
        gearbox_ratio=104.2,
        vibration_limit_mms=4.3,
        temperature_limit_c=79.0,
        rpm_limit_hss=1680.0,
        viscosity_min_cst=11.0,
        viscosity_max_cst=46.0,
        bearing_dynamic_load_c_kn=1700.0,
        bearing_equivalent_load_p_kn=240.0,
    ),
    "Gamesa-G114": TurbineSpec(
        model_name="G114-2.0 MW",
        manufacturer="Gamesa (Siemens Gamesa)",
        rated_power_mw=2.0,
        rotor_diameter_m=114.0,
        hub_height_m=93.0,
        gearbox_ratio=89.4,
        vibration_limit_mms=4.6,
        temperature_limit_c=81.0,
        rpm_limit_hss=1520.0,
        viscosity_min_cst=10.0,
        viscosity_max_cst=47.0,
        bearing_dynamic_load_c_kn=2000.0,
        bearing_equivalent_load_p_kn=280.0,
    ),
    "Nordex-N100": TurbineSpec(
        model_name="N100/2500",
        manufacturer="Nordex",
        rated_power_mw=2.5,
        rotor_diameter_m=100.0,
        hub_height_m=100.0,
        gearbox_ratio=94.7,
        vibration_limit_mms=4.4,
        temperature_limit_c=80.0,
        rpm_limit_hss=1600.0,
        viscosity_min_cst=11.0,
        viscosity_max_cst=48.0,
        bearing_dynamic_load_c_kn=2100.0,
        bearing_equivalent_load_p_kn=300.0,
    ),
    "Senvion-MM92": TurbineSpec(
        model_name="MM92",
        ...
        vibration_limit_mms=4.5,
        temperature_limit_c=79.0,
        rpm_limit_hss=1640.0,
        viscosity_min_cst=10.0,
        viscosity_max_cst=45.0,
        bearing_dynamic_load_c_kn=1800.0,
        bearing_equivalent_load_p_kn=250.0,
    ),
